...
class BadgeDesignerModal {
  constructor(options = {}) {
    ...
    console.log('BadgeDesignerModal constructor - shop:', this.shop, 'productId:', this.productId);
    this.isOpen = false;
    this.modal = null;
    this.backdrop = null;
...
window.openBadgeDesignerModal = function(productId) {
  // Get shop domain from current URL if not provided
  const shop = window.location.hostname;
  console.log('Modal opening with shop:', shop, 'productId:', productId);
